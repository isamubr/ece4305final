            ...
            switch obj.frameType
                case FrameObj.DATAFRAME %DATA
                    ...
                    elseif obj.classUse == FrameObj.DECODE;
                        ...
                        Temp =  bi2de(datainput(1+4*8:5*8,1)','left-msb');
                        ds = double(Temp*8);       
...
%frameArray
        ...
        function value = get.frameArray(obj)
            ...
            switch obj.frameType
                case obj.DATAFRAME
                    value = [obj.header; size_array'; obj.data];
                case obj.ACKFRAME
                    value = [obj.header];
                otherwise
